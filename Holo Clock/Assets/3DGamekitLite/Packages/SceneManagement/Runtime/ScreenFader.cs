...
namespace Gamekit3D
{
    public class ScreenFader : MonoBehaviour
    {
        ...
        {
            return Fade(finalAlpha, canvasGroup, fadeDuration);
        }
        ...
        {
            yield return FadeSceneOut(1f, fadeType);
        }

        public static IEnumerator FadeSceneOut(float finalAlpha, FadeType fadeType = FadeType.Black, float FadeDuration = -1)
        {
            CanvasGroup canvasGroup;
            switch (fadeType)
            {
            ...
            yield return Instance.StartCoroutine(Instance.Fade(finalAlpha, canvasGroup, FadeDuration > -1 ? FadeDuration : Instance.fadeDuration));
        }
    }
}